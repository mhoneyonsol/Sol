...
{
    transition: 2s; margin-right: 20%; width: 100%; height: 450px!important; max-height: 600px; padding-top: 20px; filter: drop-shadow(2px 4px 6px black); border: none; background-size: 100%; background-position: bottom; background: url(https://i.imgur.com/nOG6pYM.png); background-size: 15%; background-color: #00000087; color: white; background-repeat: no-repeat; background-position-x: right; background-position-y: bottom;
    backdrop-filter: blur(4px);
}
