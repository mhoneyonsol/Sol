    ...
    <div class="pop-up">
      <div class="content">
        <div class="container">
          ...
          <p style="font-family: 'Russo One', sans-serif;" class="back">0x444</p>
          <img 
            draggable="false" 
            src="https://media0.giphy.com/media/1PgEztlO5hmsMuwIAu/giphy.gif?cid=ecf05e4740500a7827d81d483a1ff8d4a33749c7e2df0755&rid=giphy.gif" 
            alt="Car" 
          />
...
<style>@import url("https://fonts.googleapis.com/css?family=Russo+One&display=swap");
$gray: #222;
$blue: #689bf6;
$yellow: #bcbcbc;
$orange: #bcbcbc;
...
.buutton {
  ...
  buutton {
    ...
    border-radius: 50px;
    background: #222;
    box-shadow: inset 15px 15px 30px #fff5, inset -15px -15px 30px #222;
    overflow: hidden;
    outline: 0;
    ...
    &:hover {
      ...
      color: $white;
      box-shadow: inset 15px 15px 30px #222, inset -15px -15px 30px #fff5;
    }
